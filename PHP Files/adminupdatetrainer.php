...
$data=mysqli_query($con,"select * from newtrainer where id='$aa'")or die(mysqli_error($con));
...
if($_SERVER['REQUEST_METHOD']=="POST"){
	...
	include_once("connect.php");
	mysqli_query($con,"update newtrainer set user='$a',pass='$b',email='$c',mobile='$d',gender='$e',fees='$g',image='$final' where id='$h'")or die(mysqli_error($con));
					...
					<div class="row">
						...
						<div class="col-md-6 offset-3 animate-box">
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										<input type="text" class="form-control" placeholder="Password" name="pass" value="<?php echo $pass ?>">
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
								...
								<div class="col-md-12">
									<div class="form-group">
										<input type="hidden" class="form-control" placeholder="Id" name="id" value="<?php echo $aa ?>">
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
										<img src="<?php echo $image ?>" height=100 width=100 title="Update Image" style="cursor:pointer;"> 
										<input type="file" class="form-control" placeholder="image" name="image" value=""> 
										<input type="hidden" class="form-control" placeholder="Id" name="id" value="<?php echo $aa ?>">
									</div>
								</div>
								<div class="col-md-12">
