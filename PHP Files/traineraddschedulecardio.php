...
if($_SERVER['REQUEST_METHOD']=="POST" && !(isset($_POST['t3']))){
	...
	if($a=="" || $b =="" || $c =="" || $d =="" || $e =="" || $f =="" || $g =="" || $h =="" || $e ==""){}
	else{
	include_once("connect.php");
	$data=mysqli_query($con,"select * from addschedulecardio where user='$a' and day='$b'")or die(mysqli_error($con));
	if(mysqli_num_rows($data)>0){
		header("location:trainerpackagedetail.php?a=".$a);
	}
	else{
	mysqli_query($con,"insert into addschedulecardio(user,trainerid,day,ex1,ex2,ex3,ex4,ex5,ex6,ex7,pid) values('$a','$tid','$b','$c','$d','$e','$f','$g','$h','$i','$pid')")
...
?>
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<input type="hidden" class="form-control" placeholder="Exercise 1" name="pid" value="<?php echo $_POST['t4'] ?>">
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
