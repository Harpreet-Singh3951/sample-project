				...
				<div class="row">
						...
						<table class="table table-strip table-responsive">
							<tr style="background-color: gray; color: white;">
								...
								<th style="text-align: center;">Status/Ending Date</th>
						...
						<?php 	
							while($ss=mysqli_fetch_assoc($data)){
								echo"<tr'>
										...
										<th style='text-align: center;'>".$ss['tdays']."(".$ss['status'].")</th>
										<th style='text-align: center;'>
										<a href=trainerdeletemypackage.php?a=".$ss['id']." class='btn btn-sm'>Delete Plan</a></th>
