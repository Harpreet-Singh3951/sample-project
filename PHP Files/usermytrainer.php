				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
						<div class="fh5co-intro fh5co-table-cell animate-box">
							<h1 class="text-center">My Trainer</h1>
		...
		<div id="fh5co-pricing-section" class="fh5co-pricing fh5co-lightgray-section">
			<div class="container">
				...
				<div class="row">
						...
						$data=mysqli_query($con,"select * from mytrainer")or die(mysqli_error($con));
						...
						<?php 	
							while($ss=mysqli_fetch_assoc($data)){
								echo"<tr>
										...
										<th style='text-align: center;'>".$ss['trainer']."</th>
										<th style='text-align: center;'>".$ss['fees']."</th>
										<th style='text-align: center;'>
										<img src='".$ss['image']."' width='30px'>
										</th>
										<th style='text-align: center;'>".$ss['status']."</th>
										<th style='text-align: center;'>
										<a href=userdeletemytrainer.php?a=".$ss['id']." class='btn btn-sm'>Delete</a></th>
									</tr>";
