				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
						<div class="fh5co-intro fh5co-table-cell animate-box">
							<h1 class="text-center">All Query Replies</h1>
		...
		<div id="fh5co-pricing-section" class="fh5co-pricing fh5co-lightgray-section">
			<div class="container">
				...
				<div class="row">
						...
						$data=mysqli_query($con,"select * from askqueryadmin where reply!=''")or die(mysqli_error($con));
						...
						<?php 	
							while($ss=mysqli_fetch_assoc($data)){
								echo"<tr'>
										...
										<th style='text-align: center;'>".$ss['reply']."</th>
										<th style='text-align: center;'>
										<th style='text-align: center;'>
										<a href='adminupdatequery.php?a=".$ss['id']."'><img src='images/icons/edit.png' title='Edit'></a>
										&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
										<a href='admindeletequery.php?a=".$ss['id']."'><img src='images/icons/delete.png' title='Delete'></a></th>
									</tr>	";
