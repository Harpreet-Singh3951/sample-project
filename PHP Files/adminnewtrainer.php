...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<!-- end:fh5co-header -->
		<div class="fh5co-parallax" style="background-image: url(images/main/13.jpg);" data-stellar-background-ratio="0.5">
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
						<div class="fh5co-intro fh5co-table-cell animate-box">
							<h1 class="text-center">Trainer Register</h1>
...
if($_SERVER['REQUEST_METHOD']=="POST"){
	...
	$data=mysqli_query($con,"select * from newtrainer where email='$c' and mobile='$d'")or die(mysqli_error($con));
	...
	if($error>0){
		...
		mysqli_query($con,"insert into newtrainer(image,user,pass,email,mobile,gender,fees) values('$final','$a','$b','$c','$d','$e','$f')") or die(mysqli_error($con));
		$_SESSION['email']=$c;
