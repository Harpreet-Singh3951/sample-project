...
if(!(isset($_SESSION['admin']))){
	...
	$data=mysqli_query($con,"select * from askqueryadmin where id='$aa'")or die(mysqli_error($con));
...
if($_SERVER['REQUEST_METHOD']=="POST"){
	...
	include_once("connect.php");
	mysqli_query($con,"update askqueryadmin set reply='$b' where id='$a'") or die(mysqli_error($con));
	header("location:adminreplytable.php");
	}
}
?>
