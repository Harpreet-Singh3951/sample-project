		...
		<div id="fh5co-pricing-section" class="fh5co-pricing fh5co-lightgray-section">
			<div class="container">
				...
				<div class="row">
						...
						$data=mysqli_query($con,"select * from newregister")or die(mysqli_error($con));
						...
						<?php 	
							while($ss=mysqli_fetch_assoc($data)){
								echo"<tr>
										...
										<a href='adminstatus.php?a=".$ss['id']."' style='text-transform:uppercase;'>".$ss['status']."</a></th>
										<th style='text-align: center;'>
										<a href='adminupdateuser.php?a=".$ss['id']."'><img src='images/icons/edit.png' title='Edit'></a>
										&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
										<a href='admindeleteuser.php?a=".$ss['id']."'><img src='images/icons/delete.png' title='Delete'></a></th>
									</tr>	";
