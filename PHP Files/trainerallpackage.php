...
if(isset($_REQUEST['a'])){
	echo"<script> alert('Package Already Selected')</script>";
}
?>
<!DOCTYPE html>
				...
				<div class="row">
					<div class="pricing" id="aa1">
						...
						<div class="price-box animate-box">
							<h2 class="pricing-plan pricing-plan-offer"><?php echo $ss['name'] ?> ((<?php echo $ss['offer'] ?>)) </h2>
							...
							<a href="trainerselectpackagedetails.php?a=<?php echo $ss['id'] ?>" class="btn btn-default">Select Plan</a>
						</div>
					</div>
<?php
							}
