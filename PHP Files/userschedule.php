		...
		<div id="fh5co-pricing-section" class="fh5co-pricing fh5co-lightgray-section">
			<div class="container">
				...
				<div class="row">
						...
						$data=mysqli_query($con,"select * from joinpackage where email='$sa'")or die(mysqli_error($con));
						...
						<table class="table table-strip table-responsive">
							<tr style="background-color: gray; color: white;">
								...
								<th style="text-align: center;">SHOW SCHEDULE</th>
							</tr>
						<?php 	
							while($ss=mysqli_fetch_assoc($data)){
								echo"<tr'>
										...
										<form action='usershowschedule.php' method='post'>
											<input type='hidden' name='t1' value=".$ss['pid'].">
