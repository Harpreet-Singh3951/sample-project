				...
				<div class="row">
						...
						<table class="table table-strip table-responsive">
							<tr style="background-color: gray; color: white;">
								...
								<th style="text-align: center;" colspan='2'>SHOW SCHEDULE</th>
							</tr>
						<?php 	
							while($ss=mysqli_fetch_assoc($data)){
								echo"<tr'>
										...
										<a href='trainershowschedule1.php?a=".$ss['email']."' style='text-transform:uppercase;'>".$ss['strength']."</a></th>
										<th style='text-align: center;'>
										<a href='trainershowschedule2.php?a=".$ss['email']."' style='text-transform:uppercase;'>".$ss['cardio']."</a></th>
