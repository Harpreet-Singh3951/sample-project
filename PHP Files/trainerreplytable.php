						...
						<?php 	
							while($ss=mysqli_fetch_assoc($data)){
								echo"<tr'>
										...
										<a href='trainerupdatequery.php?a=".$ss['id']."'><img src='images/icons/edit.png' title='Edit'></a>
										</th>
										<th style='text-align: center;'>
										
										<a href='trainerdeletereply.php?a=".$ss['id']."'><img src='images/icons/delete.png' title='Delete'></a></th>
									</tr>	";
