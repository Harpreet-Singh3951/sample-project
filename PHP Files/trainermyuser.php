...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<!-- end:fh5co-header -->
		<div class="fh5co-parallax" style="background-image: url(images/main/15.jpg);" data-stellar-background-ratio="0.5">
			<div class="container">
				<div class="row">
		...
		<div id="fh5co-pricing-section" class="fh5co-pricing fh5co-lightgray-section">
			<div class="container">
				...
				<div class="row">
						...
						$data=mysqli_query($con,"select * from mytrainer where traineremail='$aa'")or die(mysqli_error($con));
						...
						<?php 	
							while($ss=mysqli_fetch_assoc($data)){
								echo"<tr'>
										...
										<a href='trainerpackagedetail.php?a=".$ss['email']."' style='text-transform:uppercase;'>".$ss['package']."</a></th>
										<th style='text-align: center;'>
										<a href='trainerstatus.php?a=".$ss['email']."' style='text-transform:uppercase;'>".$ss['status']."</a></th>
